...
const moduleFileExtensions = ['web.mjs', 'mjs', 'web.js', 'js', 'web.ts', 'json', 'web.jsx', 'jsx'];
...
module.exports = {
  ...
  appIndexJs: resolveModule(resolveApp, 'src/App/root'),
  electronIndexJs: resolveModule(resolveApp, 'src/electron/index'),
